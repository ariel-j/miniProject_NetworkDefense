// PhishGuard - Login Form Spoofing Learning Module JavaScript
...
function showCompletionMessage(score) {
  const message = score >= 80 ? 
    'Excellent! You can identify login form spoofing well.' :
    'Good effort! Review URL verification techniques and practice more.';
...
document.addEventListener('DOMContentLoaded', () => {
  initializeQuiz();
  setupButtons();
  console.log('PhishGuard: Login Form Spoofing learning module loaded');
});