// PhishGuard - Urgency Tactics Learning Module JavaScript
...
function showCompletionMessage(score) {
  const message = score >= 80 ? 
    'Excellent! You understand urgency tactics well.' :
    'Good try! Review the material and practice identifying urgency tactics.';
...
function setupButtons() {
  ...
  if (takeQuizBtn) {
    takeQuizBtn.addEventListener('click', () => {
      alert('Full assessment feature coming soon! Continue practicing with the current quiz.');
    });
  }
...
document.addEventListener('DOMContentLoaded', () => {
  initializeQuiz();
  setupButtons();
  console.log('PhishGuard: Urgency Tactics learning module loaded');
});